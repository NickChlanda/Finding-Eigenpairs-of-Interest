# A Method for Finding Eigenstates Near an Energy of Interest For Large Sparse Matrices
...
This repository is intended to be material for paper :  . If you find this prior to paper submission, please email me at nchlandaATbrynmawr.edu
 ...
 # The 10-step pipeline
   ...
   5. Monte-Carlo targeting: repeatedly draw a candidate energy from the
      reconstructed DOS by rejection sampling. This can be changed to center a specific energy by changing Z_new
